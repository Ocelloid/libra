    ...
    return (        
        <>
            ...
            <div className="h-screen w-screen flex flex-col overflow-x-hidden overflow-y-auto" 
                 style={{backgroundImage: `url(/background-${theme}.png)`, backgroundSize: '100% 100%'}}>
                <section className="sec-container">
                    <div className="mx-10 flex md:mx-auto md:w-3/4 lg:w-2/3 xl:w-1/2 2xl:w-3/7 flex-col gap-5">
                        ...
                        <div>                            
                            <Select
                                ...
                                listboxProps={{itemClasses: {title: ["font-montserrat", "text-lg"], base: ["font-montserrat", "text-lg"]}}}
                                placeholder={t('common:choose_language')}
                                label={t('common:language')}>
                                <SelectItem
                                    key="ru"
                                    startContent={<Avatar alt="Русский" className="w-6 h-6" src="https://flagcdn.com/ru.svg"/>}>
                                    Русский
                                </SelectItem>
                                <SelectItem
                                    key="en"
