                ...
                <div className="flex w-full flex-col justify-center gap-2">
                  <div className="flex flex-row gap-2">
                    <input
                      disabled={true}
                      value={taskTitle}
                      className="mx-auto w-full rounded-sm border-slate-800 bg-gray-800 bg-opacity-60 px-2 font-montserrat tracking-wide"
                    />
                    <Tooltip
                    ...
                    >
                      <button
                        className="ml-auto rounded-sm bg-gradient-to-br from-gray-700 to-gray-800 p-2 hover:from-gray-700"
                        tabIndex={10003}
                  ...
                  <textarea
                    ...
                    disabled
                    value={taskContent}
                    className="mx-auto mb-4 w-full rounded-sm border-slate-800 bg-gray-800 bg-opacity-60 p-2 font-montserrat tracking-wide"
                  ></textarea>
                </div>
              )}
              {isEditing && (
